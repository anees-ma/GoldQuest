...
if($frnme == 'cmsad'){
 ...
 <form action="addclient.php" method="post" enctype="multipart/form-data" style="text-align:left" id="adcl_submi">
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="cmpuid">Client Reference ID: <span style="color:red">*</span></label>
...
elseif($frnme == 'timelines'){
    ?>
    <div class="form-title">Acknowledgement Pending</div>
    <div class="task_tabl">
...
elseif($frnme == 'passwrds'){
    ?>
    <div class="form-title">Client Login Credentials </div>
    <div class="task_tabl">
                <table class="tbl_data">
                    <th>SL</th>
                    <th> Client Reference ID</th>
                    ...
                    <tr>
                       ...
                       <td><a style="color:blue;font-weight:bold" href="https://admin.goldquestglobal.in/customerlogin?m=<?php echo$cllogres['email'];?>&s=<?php echo $cllogres['pas_wrd'];?>" target="_blank">Go</a></td>
                    </tr>
                    <?php
                    $o++;
                    }
...
elseif($frnme == 'ademploye'){
 ...
 <form action="addemp.php" method="post" enctype="multipart/form-data" style="text-align:left" id="add_empact">
  <div class="form-group">
    ...
    <input onkeypress="return /[0-9]/i.test(event.key)" type="text" class="form-control" id="empidd" name="empidd">
  </div>
  <div class="form-group">
    ...
    <div class="task_tabl">
                <table class="tbl_data">
                    ...
                    <tr>
                       ...
                       <td><button class="btn btn-danger" onclick="editempl(this)" data-emiid="<?php echo $empmres['id'];?>">Edit</button></td>
                    </tr>
                    <?php
                    $e++;
                    }
...
elseif($frnme == 'exclrpt'){
    ?>
    <div class="form-style">
     <div class="form-title">Download Excel Tracker</div>
...
elseif($frnme == 'reminder'){
    ?>
    <div class="form-title">TAT Exceeded WIP Cases</div>
    <div class="task_tabl">
                <table class="tbl_data">
                    <th>SL</th>
                    ...
                    <tr id="blkr<?php echo $clientid;?>">
                        ...
                        echo $cvh;
                        ?></td>
                        <td style="padding:10px"><a href="https://admin.goldquestglobal.in/masterchecker.php?ref_id=<?php echo $appid;?>" target="_blank" class="startmstr">START</a></td>
                    </tr>
                    <?php
                    $l++;
                        }
...
elseif($frnme == 'apmng'){
    ?>
    <div class="form-title">Active Client List</div>
