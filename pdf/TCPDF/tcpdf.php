...
public function Footer() {
        ...
        $this->Ln();
        $this->Cell(0, 0, 'IndiQube - Gamma Building, No. 293/154/172, 4th Floor, Outer Ring Road, Kadubeesanahalli, Marathahalli', 0, 0, 'C');
        $this->Ln();
        $this->Cell(0,0,'Bangalore-560103 | www.goldquestglobal.in', 0, false, 'C', 0, '', 0, false, 'T', 'M');
