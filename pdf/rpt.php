...
$pdf .='<table>';
$pdf .='<tr>';
$pdf .='<td>'.'<img style="width:250px" src="https://admin.goldquestglobal.in/images/logogoldquest.png">'.'</td>';
...
$pdf .='<table style="border:1px solid grey">';
$pdf .='<tr>';
$pdf .='<th style="width:190;background-color:cornflowerblue;color:black;font-weight:bold;text-align:center;border-right:2px solid white;border-left:2px solid grey;border-bottom:none;border-top:2px solid black;font-size:12px">'.'REPORT COMPONENT'.'</th>';
$pdf .='<th style="background-color:cornflowerblue;color:black;font-weight:bold;text-align:center;padding:5px;border-right:2px solid white;border-bottom:none;border-top:2px solid black;font-size:12px;width:193">'.'INFORMATION SOURCE'.'</th>';
...
$pdf .='<img src="https://admin.goldquestglobal.in/'.$phtexp[0].'" style="height:490px;width:490px">';
$pdf .='</div>';
 $ph=1;
 for($ph=1; $ph < $phtcnt; $ph++){
     ...
     $pdf .='<br>';
     $pdf .='<img src="https://admin.goldquestglobal.in/'.$phtexp[$ph].'" style="height:490px;width:490px">';
     $pdf .='</div>';
     $pdf .='</section>';
 }
$pdf .='</section>';
