<?php 
    ...
    $pdfRoot = APP_FILE_PATH.'assets/PDFReports/';
    if(!is_dir($pdfRoot)){
      mkdir($pdfRoot,0777,true);
    }
    $pdf= '';
    //$pdfFileArray = array();
    //foreach ($_POST['downloadIds'] as $key => $value) {
        $appl_id = explode('#',$value)[1];
       ...
       // $pdfRoot = APP_FILE_PATH.'assets/PDFReports/';
        ...
        //$pdfFileArray[$key]['file'] = $pdf_nme;
   // }

    //$res['pdf'] = $pdfFileArray;
        echo $pdf_nme;
