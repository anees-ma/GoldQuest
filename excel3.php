...
// $q=mysqli_query($con,"select ref_id,applic_entry.month_year,applic_entry.case_rv_dt,applic_entry.case_rcvd_month,company_name,clent_details.address,applic_entry.cand_ref_id, applic_entry.gqg_ref_id, emp_name,applic_entry.finl_rpt_dt,time,current_address,permanent_address,emp_hr_1,emp_hr_2,emp_hr_3,emp_hr_4,emp_hr_5, emp_hr_6,post_graduation,graduation,12th_std,10th_std,diploma,pro_reference_1,pro_reference_2,pro_reference_3,insta_drug_panel, criminal_police_record,criminal_court_record,court_record_curr,criminal_database,credit_verification,national_id_check,company_site_visit, DATEDIFF(applic_entry.finl_rpt_dt, applic_entry.cse_intidt) as no_of_days_taken, applic_entry.rptii_status, applic_entry.over_status from applications join applic_entry on applic_entry.appl_id = applications.ref_id join clent_details on clent_details.client_uid = applications.client_uid where applic_entry.finl_rpt_dt like '$exrefidc%'");
// $columnHeader = '';  disabled on May 21 while chaingig the line

// echo "select applic_entry.case_rcvd_month,ref_id,applic_entry.case_rv_dt,company_name,applic_entry.cand_ref_id,emp_name,applic_entry.cont_num,applic_entry.fat_ful_nme,applic_entry.dob_fath,applic_entry.gen,applic_entry.marital_stats,applic_entry.nationlty,applic_entry.pa_full_address,applic_entry.pa_pos_from,applic_entry.pa_pos_to,applic_entry.pa_landmark,applic_entry.pa_residence_mobile_no,applic_entry.pa_state,applic_entry.pa_court_address,applic_entry.ca_full_address,applic_entry.ca_landmark,applic_entry.ca_residence_mobile_no,applic_entry.ca_state,applic_entry.ca_court_address,current_address,permanent_address,emp_hr_1,emp_hr_2,emp_hr_3,emp_hr_4,emp_hr_5, emp_hr_6,post_graduation,graduation,12th_std,10th_std,diploma,pro_reference_1,pro_reference_2,pro_reference_3,insta_drug_panel,criminal_police_record,criminal_court_record,court_record_curr,criminal_database,credit_verification,national_id_check,company_site_visit,applic_entry.insf_ra_dt,applic_entry.insuf_rmrks,applic_entry.insuf_clr_dt,applic_entry.over_status,applic_entry.finl_rpt_dt from applications join applic_entry on applic_entry.appl_id = applications.ref_id where applic_entry.finl_rpt_dt like '$exrefidc%'";exit;
