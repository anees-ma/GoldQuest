<html>
   ...
   <body>
      <?php
         ...
         <div><a style='color:white;background-color:#3e76a5;padding:5px' href='https://admin.goldquestglobal.in/bgvforms/GOLDQUEST_GLOBAL_BGV_ONBOARDING_PROCESS.pdf'>PPT</a></div><br>
