...
<html>
    ...
    <body>
        <header class="head">
            <a href="<?php echo APP_PATH; ?>">GQG HR SERVICES</a><span class="log">Hi,&nbsp;<a href="<?php echo APP_PATH; ?>">Admin</a></span>
            </header>
            <section class="sec1">
                ...
                <?php if($_GET['appl_sub']=='success'){?>

                <div class="alert alert-success alert-dismissible">
                    <button id="pusurl" type="button" class="close" data-dismiss="alert">×</button>
            ...
            <?php } ?>
                <div class="form-style">
                    ...
                    <form action="mastersub.php" method="post" enctype="multipart/form-data" id="finrentry" autocomplete="off">
