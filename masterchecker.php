...
<html>
    ...
    <body>
        <header class="head">
            <a href="https://admin.goldquestglobal.in">GQG HR SERVICES</a><span class="log">Hi,&nbsp;<a href="https://admin.goldquestglobal.in">Admin</a></span>
            </header>
            <section class="sec1">
                ...
                <div class="form-style">
                    <div class="form-title">Candidate Application</div>
