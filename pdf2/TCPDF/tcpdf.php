...
public function Footer() {
        ...
        $this->Cell(0, 0, '____________________________________________________________________________________________________________________________________________________________', 0, 0, 'C');
        $this->Ln();
        /*$this->Cell(0, 0, '# 18, Krishna Summit, Shop No 303 B, 3rd Floor, Marathahalli Outer Ring Road, Bangalore – 560037', 0, 0, 'C');
        $this->Ln();
        $this->Cell(0,0,'Next to Canara Bank | Phone: +91-80-48663693 | www.goldquestglobal.in', 0, false, 'C', 0, '', 0, false, 'T', 'M');*/
