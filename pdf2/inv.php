...
$pdf .='<td style="text-align:right">'.'GSTIN: '.$gst.' <br>State: '.ucfirst($state).' <br>Invoice Date: '.$dap.'<br> Invoice Number: '.$invnum.'<br>State Code: '.$stcde.'</td>';
$pdf .='</tr>';
$pdf .='</table>';
$pdf .='<br><br>';
$pdf .='<table>';
...
/*                            $srco=mysqli_query($con,"select * from $srcimplo where appl_id='$appl_id'");
                            ...
                            $pdf .='<td style="border:1px solid black;text-align:center">'.$sac_code.'</td>';
                            ...
                            $cte=$sub_cateexp[$z];
                            $cteexp=explode('-',$cte);
                            //$cteimplo=implode('_',$cteexp);##Disabled on 14/02/2021 - By Anees

                            $cteimplo='applications.'.implode('_',$cteexp);//Added on 14/02/2021 - By Anees
                            
                            ###Query disabled by Anees on 02/14/2021
                            ...
                            ###Query added by Anees on 02/14/2021 by Anees instead of the above disabled query
                            $cteqry=mysqli_query($con,"select applications.*, applic_entry.over_status from applications inner join applic_entry on applic_entry.appli_id = applications.ref_id where applic_entry.finl_rpt_dt like '%$mandyr2%' && $cteimplo !='nil' && $cteimplo !='' && applications.client_uid='$client_uid' && applic_entry.over_status='$com_lted'");
                            ...
                            $pdf .='<td style="border:1px solid black;text-align:center;width:50">'.$totcnt[$h].'</td>';
                            ...
                            $pdf .='<td style="border:1px solid black;text-align:center;width:50">'.$final_unt.'</td>';
                            $pdf .='<td style="border:1px solid black;text-align:center;width:120">'.$adfnt[$h].'</td>';
                            $pdf .='<td style="border:1px solid black;text-align:center">'.(($totcnt[$h])*($final_unt)+($adfnt[$h])).'</td>';
                            $pdf .='<td style="border:1px solid black;text-align:center;width:90">'.(($totcnt[$h])*($final_unt)+($adfnt[$h])).'</td>';
                            $pdf .='</tr>';
                        }
                        $pdf .='<tr>';
                        $pdf .='<td style="border:1px solid black;text-align:left;">'.' Total'.'</td>';
                        $pdf .='<td style="border:1px solid black;text-align:center">'.''.'</td>';
                        $pdf .='<td style="border:1px solid black;text-align:center">'.$qrtt.'</td>';
                        $pdf .='<td style="border:1px solid black;text-align:center">'.''.'</td>';
                        $pdf .='<td style="border:1px solid black;text-align:center">'.$adl_tot.'</td>';
                        $pdf .='<td style="border:1px solid black;text-align:center">'.$totamnt.'</td>';
                        $pdf .='<td style="border:1px solid black;text-align:center">'.$totamnt.'</td>';
                        $pdf .='</tr>';
$pdf .='</table>';
$pdf .='<br><br>';
...
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.$taxamnta.'</td>';
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.'9%'.'</td>';
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.$taxamnta.'</td>';
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.''.'</td>';
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.''.'</td>';
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.($taxamnta*2).'</td>';
$pdf.='</tr>';
...
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.$taxamnt.'</td>';
$pdf .='<td style="border:1px solid black;text-align:center;color:black">'.$taxamnt.'</td>';
$pdf.='</tr>';
...
$pdf .='<th style="border:1px solid black;text-align:center">'.$totamnt.'</th>';
$pdf .='</tr>';
...
$pdf .='<td style="border:1px solid black;text-align:center">'.$taxamnta.'</td>';
$pdf .='</tr>';
...
$pdf .='<td style="border:1px solid black;text-align:center">'.$spltax.'</td>';
$pdf .='</tr>';
...
$pdf .='<td style="border:1px solid black;text-align:center">'.$igst.'</td>';
$pdf .='</tr>';
...
$pdf .='<td style="border:1px solid black;text-align:center">'.$spltot.'</td>';
$pdf .='</tr>';
...
$pdf .='<td style="border:1px solid black;text-align:center;font-weight:bold">'.$splfinl.'</td>';
$pdf .='</tr>';
...
$pdf .='</table>';
$pdf .='<br>';
$pdf .='<div style="background-color:white;color:black;border:1px solid black;font-weight:bold">'.'Total Invoice Amount in words : '.ucwords($numc).' Rupees Only'.'</div>';
$pdf .='<br>';
$pdf .='<table>';
$pdf .='<tr>';
...
$pdf .='<th></th>';
$pdf .='<th></th>';
$pdf .='<th style="text-align:right">'.'<img style="width:100px" src="http://www.goldquestglobal.in/images/newsig.jpg" >'.'</th>';
$pdf .='</tr>';
$pdf .='</table>';
...
$pdf .='<br>';
$pdf .='<div>'.'EDU1-Post-Graduation | EDU2-Graduation | EDU3-12th-Std | EDU4-10th-Std | EDU5-Diploma | PR1-Pro-Reference-1 | PR2-pro-reference-2 | 
PA-Permanent-Address | CA-Current-Address | EMP-HR-1-EHR1 | EMP-HR-2-EHR2 | EMP-HR-3-EHR3 | EMP-HR-4-EHR4 | EMP-HR-5-EHR5 | EMP-HR-6-EHR6 | 
EMP-HR-7-EHR7 | EMP-HR-8-EHR8 | 12PL-12-Panel | 10PL-10-Panel | 6PL-6-Panel | 5PL-5-Panel | CSV-Company-Site-Visit | NID-National-ID-Check | 
CRE-Credit-Verification | DBC-Criminal-Database | CCR-Criminal-Court-record | CPV-Criminal-Police-Record'.'</div>';
$pdf .='<br>';
...
$pdf .='<tr>';
$pdf .='<th style="border:1px solid black;font-size:10px;text-align:center"><strong>'.'SL'.'</strong></th>';
$pdf .='<th style="border:1px solid black;font-size:10px;text-align:center"><strong>'.'Ref Id'.'</strong></th>';
$pdf .='<th style="border:1px solid black;font-size:10px;text-align:center"><strong>'.'Emp Name'.'</strong></th>';
//serives th st
$k=0;
for($k=0; $k < $serv_count; $k++){
    $servicename=$serv_exp[$k];
      $snmeexp=explode('#',$servicename);
       ...
       $serfinl=$snmeexp[1];
       $adto_serv=$snmeexp[0];
       $insrcd=mysqli_query($con,"select * from display_names where service_name='$serfinl'");
       $insrcdres=mysqli_fetch_assoc($insrcd);
       $finvcde=$insrcdres['inv_code'];
       $addto_list;
       $addto_list=$adto_serv.','.$addto_list;
    $pdf .='<th style="border:1px solid black;font-size:8px;font-weight:bold;text-align:center">'.ucwords($finvcde).'</th>';
}
//serives th ed

$pdf .='<th style="border:1px solid black;font-size:10px;text-align:center"><strong>'.'Add Fee'.'</strong></th>';
$pdf .='<th style="border:1px solid black;font-size:10px;text-align:center"><strong>'.'Total'.'</strong></th>';

$pdf .='<th style="border:1px solid black;font-size:10px;text-align:center"><strong>'.'Report Date'.'</strong></th>';
$pdf .='</tr>';

##Disabled on 14/02/2021 by Anees
//$qry5=mysqli_query($con,"select * from applications where date like '%$mandyr%' && client_uid='$client_uid' && status='$com_lted'");

##Query added on 14/02/2021 by Anees instead of the above disabled query
$qry5=mysqli_query($con,"select applications.*, applic_entry.over_status from applications inner join applic_entry on applic_entry.appli_id = applications.ref_id where applic_entry.finl_rpt_dt like '%$mandyr2%' &&  applications.client_uid='$client_uid' && applic_entry.over_status='$com_lted'");
$n=0;
$v=0;
$sl=1;
...
$fee=mysqli_query($con,"select * from applic_entry where appl_id='$refid' order by cand_ref_id ASC");
...
$givrefid=$feeres['cand_ref_id'];


$empname=$qryres5['emp_name'];
$pdf .= '<tr>';
$pdf .='<td style="border:1px solid black;font-size:8px;text-align:center">'.$sl.'</td>';
$pdf .='<td style="border:1px solid black;font-size:8px;text-align:center">'.$givrefid.'</td>';
$pdf .='<td style="border:1px solid black;font-size:8px;text-align:center">'.$empname.'</td>';
$k=0;
for($k=0; $k < $serv_count; $k++){
    //selection status in applications tb

    ##Query disabled on 14/02/2021 by Anees
    //$prg=mysqli_query($con,"select * from applications where date like '%$mandyr%' && ref_id='$refid' && status='$com_lted'");

    ## Added another query instead of the disabled query on 14/02/2021 by Anees
    $prg=mysqli_query($con,"select applications.*, applic_entry.over_status from applications inner join applic_entry on applic_entry.appli_id = applications.ref_id where applic_entry.finl_rpt_dt like '%$mandyr2%' && applications.ref_id='$refid' && applic_entry.over_status='$com_lted'");
...
$pdf .='<td style="border:1px solid black;font-size:8px;text-align:center">'.$ad_fee.'</td>';
$pdf .='<td style="border:1px solid black;font-size:8px;text-align:center">'.(($pri_mg[$n])+($ad_fee)).'</td>';
$pdf .='<td style="border:1px solid black;font-size:8px;text-align:center">'.$date.'</td>';
$pdf .= '</tr>';
$n++;
$v++;
$sl++;
