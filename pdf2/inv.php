...
$pdf .='<table>';
$pdf .='<tr>';
$pdf .='<td>'.'<img style="width:250px;border:none" src="https://admin.goldquestglobal.in/images/logogoldquest.png">'.'</td>';
...
$pdf .='<th></th>';
$pdf .='<th></th>';
$pdf .='<th style="text-align:right">'.'<img style="width:100px" src="https://admin.goldquestglobal.in/images/newsig.jpg" >'.'</th>';
$pdf .='</tr>';
$pdf .='</table>';
...
$pdf .='<tr>';
$pdf .='<th style="border:1px solid black;font-size:12px;text-align:center"><strong>'.'SL'.'</strong></th>';
...
for($k=0; $k < $serv_count; $k++){
    ...
    $pdf .='<th style="border:1px solid black;font-size:10px;font-weight:bold;text-align:center">'.ucwords($finvcde).'</th>';
}
//serives th ed
...
$pdf .= '<tr>';
$pdf .='<td style="border:1px solid black;font-size:12px;text-align:center">'.$sl.'</td>';
$pdf .='<td style="border:1px solid black;font-size:12px;text-align:center">'.$givrefid.'</td>';
