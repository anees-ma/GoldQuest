...
<!DOCTYPE html>
<html lang="en">
<link rel="icon" href="http://www.goldquestglobal.in/images/favicon.ico">
<head>
    <meta charset="utf-8">
                ...
                <div class="col-lg-10 col-md-12 login-box">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 log-det">
                            ...
                            <div class="text-box-cont">
                                <form class="login100-form validate-form" action="../admin-login.php" method="post" id="login-form">
                    ...
                    ?></div>
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="input100 form-control" placeholder="Email" aria-label="Username" id="email" name="email" aria-describedby="basic-addon1">
                                     ...
                                     <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="input100 form-control" name="pass" id="pass" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1">
                                    </div>
                                    ...
                                    <div class="row" style="text-align: center">
                                        <a href="http://www.goldquestglobal.in/login/forgetpas.php" style="text-align: center; width: 90%; margin-left: auto; margin-right: auto;"><p class="forget-p">Forgot/ Change Password? <!-- <span>Sign Up Now</span> --></p></a>
                                    </div>
                                     <!-- <div class="row">
