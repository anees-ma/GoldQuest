...
<div class="shop_bx">
    ...
    <table class="shp_tbl">
        <tr class="shp_tr">
            <td class="shp_tdt">Client Code</td>
        ...
        <tr class="shp_tr">
            ...
            <td class="shp_tda">
                <?php 
                if($shpvres['agrefile'] != NULL){
                  ?>
                  <a href="http://www.goldquestglobal.in/<?php echo $shpvres['agrefile'];?>" class="docstyl" target="_blank">Document</a>
                  <?php
                }
                ?>
            </td>
