...
<div class="form-group">
                            ...
                            <input type="text" class="rqd form-control" name="may" id="may" value="<?php echo $pmay;?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="cntnum">Contact Number<span class="red-t">*</span></label>
                            <input type="text" onkeypress="return /[0-9]/i.test(event.key)" class="rqd form-control" name="cntnum" id="cntnum" value="<?php echo $pcntnum;?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="dob">Date of Birth<span class="red-t">*</span>:</label>
                            <input type="date" class="rqd form-control" name="dob" id="dob" value="<?php echo $pdob;?>" max="9999-12-31" required>
                        </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="rqd form-control" name="cindate" id="cindate" value="<?php echo $pcindate;?>" max="9999-12-31" required>
                        </div>
...
for($i=0; $i < $exp1cnt; $i++){
   ...
   ?>
   <div class="servdesc">
       <?php echo str_replace('-',' ',strtoupper($serv_nmef));?>&nbsp;
...
?>
                        ...
                        for($h=0; $h < $njcnt; $h++){
                            ...
                            ?>
                            <div class="sec_div">
                            <div class="bck_titl"><?php echo str_replace("-"," ",strtoupper($sece_nme));?></div>
                        ...
                        <div class="form-group">
                            <label for="rptsta">Report Status<span class="red-t">*</span>:</label>
                            <select class="rqd sesty" name="rptsta" id="rptsta" required>
                        ...
                        <div class="form-group">
                            <label for="rpttypei">Report Type<span class="red-t">*</span>:</label>
                            <select class="rqd sesty" name="rpttypei" id="rpttypei" required>
                                <option>--Select--</option>
                        ...
                        <div class="form-group">
                            <label for="finlversta">Final Verification Status<span class="red-t">*</span>:</label>
                            <select class="rqd sesty" name="finlversta" id="finlversta" required>
                                <option>--Select--</option>
                                <option>GREEN</option>
                                <option>RED</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="rqd form-control" name="dystk" id="dystk" value="<?php echo $pdystk;?>" max="9999-12-31" required>
                        </div>
                        <!--<div class="form-group">
