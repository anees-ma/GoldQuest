...
elseif($new_pin != NULL){
    ...
    <div id="gotol" style="text-align:center;margin-top:10px;"><button onclick="location.href='https://admin.goldquestglobal.in/customerlogin'" class="btn btn-success">Go To Login</button></div>
    <?php
    }
    else{
        ?>
