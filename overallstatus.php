...
<div class="task_tabl" style="overflow-x: scroll;">
...
while($qryres=mysqli_fetch_assoc($qry)){
    ...
    ?>
        ...
        <tr>
            ...
            <!-- <td><a href="http://www.goldquestglobal.in/masterchecker.php?ref_id=<?php echo $qryres['ref_id'];?>" target="_blank" class="startmstr">START</a></td> #CH-->
