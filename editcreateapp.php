...
//Added by Anees M A on May 18, 2021
...
$services = json_encode($services);//Added - Anees M A on May 18, 2021
...
$qry=mysqli_query($con,"update applications set docs='$finldoc',emp_name='$empnme',apl_rmrk='$rm_mr',services='$services' where ref_id='$dropapldi'");
if($qry){
    ?>
       <script>
      /*alert('success');*/
