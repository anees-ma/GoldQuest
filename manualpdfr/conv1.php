...
$pdf .='<table style="border:1px solid grey">';
$pdf .='<tr>';
$pdf .='<th style="background-color:cornflowerblue;color:white;font-weight:bold;text-align:center;padding:5px;border:1px solid white;border-left:1px solid grey;font-size:12px">'.'REPORT COMPONENT'.'</th>';
...
<!--$pdf .='<table style="border:1px solid grey">';
$pdf .='<tr>';
$pdf .='<th style="background-color:blue;color:white;font-weight:bold;text-align:center">'.'REPORT COMPONENT'.'</th>';
$pdf .='<th style="background-color:blue;color:white;font-weight:bold;text-align:center">'.'INFORMATION SOURCE'.'</th>';
