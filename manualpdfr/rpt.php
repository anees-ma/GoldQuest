...
$pdf .='<table>';
$pdf .='<tr>';
$pdf .='<td>'.'<img style="width:250px" src="http://www.goldquestglobal.in/images/logoquestglobal200new.png">'.'</td>';
...
$pdf .='<table style="border:1px solid grey">';
$pdf .='<tr>';
$pdf .='<th style="width:190;background-color:#3e76a5;color:white;font-weight:bold;text-align:center;padding:5px;border-right:1px solid white;border-left:1px solid grey;border-bottom:1px solid #3e76a5;font-size:12px">'.'SCOPE OF SERVICE NAME'.'</th>';
$pdf .='<th style="background-color:#3e76a5;color:white;font-weight:bold;text-align:center;padding:5px;border-right:1px solid white;border-bottom:1px solid #3e76a5;font-size:12px;width:193">'.'INFORMATION SOURCE NAME'.'</th>';
...
if($partqryres['report'] != NULL){
 $pdf .='<img src="http://www.goldquestglobal.in/'.$partqryres['report'].'" style="height:550px;width:400px">';   
