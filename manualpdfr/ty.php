...
$pdf .='<table style="border:1px solid grey">';
$pdf .='<tr>';
$pdf .='<th style="background-color:cornflowerblue;font-weight:bold;text-align:center;padding:5px;border:1px solid white;border-left:1px solid grey;font-size:12px">'.'SCOPE OF SERVICE NAME'.'</th>';
