...
<style>
    ...
    .company-info-t td:nth-child(even) {
        background-color: #3e76a5;
        color: white;
    }
    .company-info-t td:nth-child(odd) {
    ...
    <body>
        <header class="head">
           ...
           <!--<div class="log">Hi,&nbsp;<?php echo $company_name;?></div>-->
            ...
            <div class="ems-sub">
                <div class="bnpl" onclick="crap(this)"  data-crp="cretapl"><img src="images/next.png">&nbsp;&nbsp;CLIENT DROPBOX</div>
                <div class="bnpl" onclick="candidateDropBox(this)"  data-cdb="cdb"><img src="images/next.png">&nbsp;&nbsp;CANDIDATE DROPBOX</div>
                <div class="bnpl" onclick="apm(this)"  data-apg="apmng"><img src="images/next.png">&nbsp;&nbsp;TRACK VERIFICATION STATUS</div>
            ...
            <div class="right_con">
                <div class="prf_titl">COMPANY INFO</div>
                <div class="prf_bx">
                <div class="prf_blk">
                ...
                <div class="prf_blk">
                    <lable>Selected Services:</lable>
                    <div class="">
                        <table class="company-info-t" style="border: none">
                    <?php 
                    $t=0;
                    $f=1;
                    for($t=0; $t < $serv_name2cnt; $t++){
                        ...
                        <!-- <div class="serv_list"><span><?php echo $f.'.';?></span>&nbsp;<span><?php echo strtoupper($mjjserv);?></span>&nbsp;<span class="submaj"><?php echo ucwords($majservnme2);?></span>&nbsp;&nbsp;<?php echo $servli_priceexp[$t].' '.'RS'?></div> -->
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left"><?php echo ucwords($majservnme2);?></td>
