...
<html>
    ...
    <body>
        <header class="head">
            <a href="https://admin.goldquestglobal.in/customer-index.php">GoldQuest Verification Tracking System-VTS</a><span class="log">Hi,&nbsp;<a href="customer-index.php"><?php echo ucwords($company_name);?></a></span>
           <!--<div class="log">Hi,&nbsp;<?php echo $company_name;?></div>-->
            ...
            <div class="ems-sub">
                <div class="bnpl" onclick="crap(this)"  data-crp="cretapl"><img src="images/next.png">&nbsp;&nbsp;DROPBOX</div>
