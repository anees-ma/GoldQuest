...
//mail st
if($ovrlst == 'completed' && $isverified == 'yes'){
         $to =$client_email;
      ...
      <div>Our customer service team will be available for any support  24 x 7.</div><br>
         <div><a href='".APP_PATH."/pdf/rpt.php?reff_id=$apid'><button style='background-color:#337fbf;color:white;border:none'>Download Final Report</button></a></div><br>
      ...
      //   $header .= "Cc:geethanjali089@gmail.com,$client_email2,$client_email3,$client_email4 \r\n";
         ...
         $header .= "Cc:manjunath@goldquestglobal.in,$client_email2,$client_email3 \r\n";
         $header .= "MIME-Version: 1.0\r\n";
         $header .= "Content-type: text/html\r\n";
         $retval = mail ($to,$subject,$message,$header);
}elseif($isverified == 'no'){
         $subject = "Report For Verification";
         $message .= "<div>Dear QC Team,</div><br>
         <div><strong>$mgendi $canfnmeoo, Application ID:$apid, </strong> Final Background Verification Report is ready in GoldQuest VTS Portal, Kindly download for verification.</div><br>
         <div><a href='".APP_PATH."/pdf/rpt.php?reff_id=$apid'><button style='background-color:#337fbf;color:white;border:none'>Download Report</button></a></div><br>
...
if($apid != NULL){
    if($datscnt == 0){
        ...
        //insert data
$qry=mysqli_query($con,"insert into applic_entry(appl_id,cand_ref_id,month_year,case_rv_dt,case_rcvd_month,clnt_ful_nme,clnt_emp_id,gqg_ref_id,cand_ful_name,cont_num,
...
pos_curadr,prm_cldmrk,res_lm,state_st2,cse_intidt,insf_ra_dt,insuf_rmrks,insuf_clr_dt,over_status,finl_rpt_dt,clr_cde,no_dys_tkn,addl_fee,rmrks,rptii_status,rptii_type,finlverifi_sta,clicomlocii,pa_full_address,pa_pos_from,pa_pos_to,pa_landmark,pa_residence_mobile_no,pa_state,pa_court_address,ca_full_address,ca_landmark,ca_residence_mobile_no,ca_state,ca_court_address,date,is_quality_verified) 
values('$apid','$candrefid','$may','$csrdt','$case_rcvd_month','$clfnme','$clempid','$grefid','$canfnmeoo','$cntnum','$cntnum2','$fnme','$dob','$gender','$martsta',
'$natilty','$cmpaddr','$pinco','$perofsty','$prmldmrk','$resml','$state','$cmplcadd','$cmplcpin','$perstycrrd','$curpromiland','$cursreslm',
'$curstate','$cindate','$inrdt','$inrmrk','$incldt','$ovrlst','$firesnt','$clrcde','$dystk','$adfee','$finrmrk','$rptsta','$rpttypei','$finlversta','$clcmloci','$pa_full_address','$pa_pos_from','$pa_pos_to','$pa_landmark','$pa_residence_mobile_no','$pa_state','$pa_court_address','$ca_full_address','$ca_landmark','$ca_residence_mobile_no','$ca_state','$ca_court_address','$dap','$isverified')");
...
if($qry){
    ...
    $insta_drug_panel=$_POST['stainsta_drug_test'];// ADded for insta drug panel by Anees on Mar 12, 2021
    ...
    national_id_check='$stanational_id_check',company_site_visit='$stacompany_site_visit',status='$ovrlst' where ref_id='$apid'");*/#CH - Removed Drug Panels and added insta_drug_panel instead in below query by Anees M A on Mar 12, 2021


    $qry2=mysqli_query($con,"update applications set emp_name='$canfnmeoo',current_address='$stacurrent_address',permanent_address='$stapermanent_address', 
    emp_hr_1='$staemp_hr_1',emp_hr_2='$staemp_hr_2',emp_hr_3='$staemp_hr_3',emp_hr_4='$staemp_hr_4',emp_hr_5='$staemp_hr_5',emp_hr_6='$staemp_hr_6',post_graduation='$stapost_graduation',graduation='$stagraduation',12th_std='$std_12',10th_std='$std_10',
    diploma='$stadiploma',pro_reference_1='$stapro_reference_1',pro_reference_2='$stapro_reference_2',pro_reference_3='$stapro_reference_3',insta_drug_panel='$insta_drug_panel',criminal_court_record='$stacriminal_court_record',court_record_curr='$stacourt_record_curr',
    criminal_database='$stacriminal_database',credit_verification='$stacredit_verification',criminal_police_record='$stacriminal_police_record',
    national_id_check_1='$stanational_id_check_1',national_id_check_2='$stanational_id_check_2',company_site_visit='$stacompany_site_visit',status='$ovrlst' where ref_id='$apid'");
    if($qry2){
       ...
       // $ser_nme=$selres2['service_name'];#CH on March 22 - 2021 by Anees M A(Selected services should be taken from candidates service list(application) not from client details) - So replaced with the below line
        $ser_nme=json_decode($selres['services']);

        $serviceList=array_map("servicelistSelected",$ser_nme);
        //$ser_nme=substr($selres['services'], strpos($selres['services'], "#") + 1);
        ...
        $h=0;
        //for($h=0; $h < $njcnt; $h++){
        foreach ($serviceList as $key => $Svalue) {
            $srv_id=$njexp[$h];
...
/*            $appl_details=$bqryrs['appl_shrt'];
            ...
            }elseif($sece_nme == 'pro-reference-3'){
                include 'datasubmi/pro_reference_3.php';
            }
            ...
            }elseif($sece_nme == 'insta-drug-test'){
                include 'datasubmi/insta-drug-test.php';
            }
            ...
            elseif($sece_nme == 'court-record-curr'){
                include 'datasubmi/court_record_curr.php';
            }
            ...
            elseif($sece_nme == 'national-id-check-1'){
                include 'datasubmi/national_id_check_1.php';
            }
            elseif($sece_nme == 'national-id-check-2'){
                include 'datasubmi/national_id_check_2.php';
            }
            elseif($sece_nme == 'company-site-visit'){
                include 'datasubmi/company_site_visit.php';
            }
        }
        header('location:'.APP_PATH.'/masterchecker.php?ref_id='.$apid.'&appl_sub=success');
    }
}
else{
    echo 'oOPS!';
    ...
    //update data
$qryup=mysqli_query($con,"update applic_entry set month_year='$may',cand_ref_id='$candrefid',case_rv_dt='$csrdt',case_rcvd_month='$case_rcvd_month',clnt_ful_nme='$clfnme',clnt_emp_id='$clempid',gqg_ref_id='$grefid',cand_ful_name='$canfnmeoo',cont_num='$cntnum',cont_num2='$cntnum2',
...
addl_fee='$adfee',rmrks='$finrmrk',rptii_status='$rptsta',date='$dap',rptii_type='$rpttypei',finlverifi_sta='$finlversta',clicomlocii='$clcmloci',pa_full_address='$pa_full_address',pa_pos_from='$pa_pos_from',pa_pos_to='$pa_pos_to',pa_landmark='$pa_landmark',pa_residence_mobile_no='$pa_residence_mobile_no',pa_state='$pa_state',pa_court_address='$pa_court_address',ca_full_address='$ca_full_address',ca_landmark='$ca_landmark',ca_residence_mobile_no='$ca_residence_mobile_no',ca_state='$ca_state',ca_court_address='$ca_court_address',is_quality_verified='$isverified' where appl_id='$apid'");
...
if($qryup){
    ...
    10_panel='$panel_10',12_panel='$panel_12',criminal_court_record='$stacriminal_court_record',
    criminal_database='$stacriminal_database',credit_verification='$stacredit_verification',criminal_police_record='$stacriminal_police_record',
    national_id_check='$stanational_id_check',company_site_visit='$stacompany_site_visit',status='$ovrlst' where ref_id='$apid'");*/#CH - disabled by adding below updated query(removed panel by adding insta_drug_panel instead)
...
/*            $appl_details=$bqryrs['appl_shrt'];
            ...
            if($sece_nme == 'post-graduation'){
                ...
                foreach($_FILES["filepost_graduation"]["tmp_name"] as $key=>$tmp_name) {
                              ...
                              $coverImgdir = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == 'pro-reference-1'){
                ...
                foreach($_FILES["filepro_reference_1"]["tmp_name"] as $key6=>$tmp_name6) {
                              ...
                              $coverImgdir6 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == 'pro-reference-3'){
                //report upload st
                //selection of docs in applications
                   $sel2anxN7=mysqli_query($con,"select * from pro_reference_3 where appl_id='$apid'");
                   $selresanx2N7=mysqli_fetch_assoc($sel2anxN7);
                   $docsN7=$selresanx2N7['report'];
                 if($filcnttpro_reference_3 > 0){
                   $docsexpN7=explode(',',$docsN7);
                   $docscntN7=count($docsexpN7)-1;
                   $dcN7=0;
                   for($dcN7=0; $dcN7 < $docscntN7; $dcN7++){
                   $doconeN7=$docsexpN7[$dcN7];
                   unlink($doconeN7);
                   }
                foreach($_FILES["filepro_reference_3"]["tmp_name"] as $keyN7=>$tmp_nameN7) {
                              ...
                              $imgRANDMN7='pro3up'.$apid.$imgRANDMRN7;
            ...
            /*$coverImgdir = $coverImgdir.'/'.$imagename;*/
              ...
              $postgrN7=ltrim($postgrN7,',').',';
                ...
                //report upload ed
                $pro3=mysqli_query($con,"update pro_reference_3 set rrfnmet='$rrfnmet',rcndtlst='$rcndtlst',rvbyt='$rvbyt',raswsubt='$raswsubt',rapsptt='$rapsptt',rarimpt='$rarimpt',rapkacht='$rapkacht',rrfnmet2='$rrfnmet2',rcndtlst2='$rcndtlst2',rvbyt2='$rvbyt2',raswsubt2='$raswsubt2',rapsptt2='$rapsptt2',
                rarimpt2='$rarimpt2',rapkacht2='$rapkacht2',remarks='$rmkpro_reference_3',date='$dap',source='$srocpro_reference_3',location='$lcntinpro_reference_3',cmpl_date='$cmpdtepro_reference_3',color_code='$clrcdepro_reference_3',add_fe='$add_feepro_reference_3',report='$postgrN7' where appl_id='$apid'");
                if($pro2){
                    /*?>
                    <div style="text-align:center"><span style="border:1px solid orange;padding:5px;border-radis:10px">Education Check</span></div>
                    <?php*/
            ...
            /*$coverImgdir = $coverImgdir.'/'.$imagename;*/
              ...
              $postgr9=ltrim($postgr9,',').',';
                ...
                //report upload st
                //selection of docs in applications
                   $sel2anx10=mysqli_query($con,"select * from insta_drug_test where appl_id='$apid'");
                   $selresanx210=mysqli_fetch_assoc($sel2anx10);
                   $docs10=$selresanx210['report'];
                 if($filcnttinsta_drug_test > 0){
            ...
            /*$coverImgdir = $coverImgdir.'/'.$imagename;*/
              ...
              $postgr10=ltrim($postgr10,',').',';
                ...
                $fpl=mysqli_query($con,"update insta_drug_test set nmcdidg='$nmcdidg',totstdg='$totstdg',dktpedg='$dktpedg',rsnftstdg='$rsnftstdg',tstresdg='$tstresdg',spciddg='$spciddg',cocainedg='$cocainedg',opiatesdg='$opiatesdg',
                propoxyphenedg='$propoxyphenedg',marijuanadg='$marijuanadg',amphetaminesdg='$amphetaminesdg',benzodiazepinesdg='$benzodiazepinesdg',nmcdidg2='$nmcdidg2',totstdg2='$totstdg2',dktpedg2='$dktpedg2',rsnftstdg2='$rsnftstdg2',
                tstresdg2='$tstresdg2',spciddg2='$spciddg2',methadonedg='$methadonedg',phencyclidinedg='$phencyclidinedg',methamphetaminedg='$methamphetaminedg',oxycodonedg='$oxycodonedg',barbituratesdg='$barbituratesdg',cannabinoidsdg='$cannabinoidsdg',remarks='$rmkinsta_drug_test',date='$dap',source='$srocinsta_drug_test',location='$lcntininsta_drug_test',cmpl_date='$cmpdteinsta_drug_test',color_code='$clrcdeinsta_drug_test',add_fe='$add_feeinsta_drug_test',report='$postgr10' where appl_id='$apid'");
                if($fpl){
            ...
            elseif($sece_nme == '6-panel'){
                ...
                foreach($_FILES["file6_panel"]["tmp_name"] as $key11=>$tmp_name11) {
                              ...
                              $coverImgdir11 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == '10-panel'){
                ...
                foreach($_FILES["file10_panel"]["tmp_name"] as $key12=>$tmp_name12) {
                              ...
                              $coverImgdir12 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == '12-panel'){
                ...
                foreach($_FILES["file12_panel"]["tmp_name"] as $key13=>$tmp_name13) {
                              ...
                              $coverImgdir13 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == 'emp-hr-2'){
                ...
                foreach($_FILES["fileemp_hr_2"]["tmp_name"] as $key15=>$tmp_name15) {
                              ...
                              $coverImgdir15 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == 'emp-hr-5'){
                ...
                foreach($_FILES["fileemp_hr_5"]["tmp_name"] as $key18=>$tmp_name18) {
                              ...
                              $coverImgdir18 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == 'emp-hr-7'){
                ...
                foreach($_FILES["fileemp_hr_7"]["tmp_name"] as $key20=>$tmp_name20) {
                              ...
                              $coverImgdir20 = APP_FILE_PATH.'assets/'.$mobile.'/'.'bckver/'.$apid.'/';
            ...
            elseif($sece_nme == 'criminal-database'){
               // echo 'test'; exit;
                ...
                //selection of docs in applications
                   ...
                   //echo '<pre>'; print_r($selresanx222); exit;
                   $docs22=$selresanx222['report'];
            ...
            elseif($sece_nme == 'court-record-curr'){
                //report upload st
                //selection of docs in applications
                   $sel2anxN23=mysqli_query($con,"select * from court_record_curr where appl_id='$apid'");
                   $selresanx2N23=mysqli_fetch_assoc($sel2anxN23);
                   $docsN23=$selresanx2N23['report'];
                 if($filcnttcourt_record_curr > 0){
                   $docsexpN23=explode(',',$docsN23);
                   $docscntN23=count($docsexpN23)-1;
                   $dcN23=0;
                   for($dcN23=0; $dcN23 < $docscntN23; $dcN23++){
                   $doconeN23=$docsexpN23[$dcN23];
                   unlink($doconeN23);
                   }
            ...
            /*$coverImgdir = $coverImgdir.'/'.$imagename;*/
              ...
              $postgrN23=ltrim($postgrN23,',').',';
                ...
                //report upload ed
                $crcrtcurr=mysqli_query($con,"update court_record_curr set crtrefidcr='$crtrefidcr',crtcdnmecr='$crtcdnmecr',crtdobcr='$crtdobcr',crtftnmecr='$crtftnmecr',crtaddrcr='$crtaddrcr',crtrefidcr2='$crtrefidcr2',crtcdnmecr2='$crtcdnmecr2',crtdobcr2='$crtdobcr2',crtftnmecr2='$crtftnmecr2',crtaddrcr2='$crtaddrcr2',remarks='$rmkcourt_record_curr',date='$dap',source='$sroccourt_record_curr',location='$lcntincourt_record_curr',cmpl_date='$cmpdtecourt_record_curr',color_code='$clrcdecourt_record_curr',add_fe='$add_feecourt_record_curr',report='$postgrN23' where appl_id='$apid'");
                if($crcrtcurr){
                    /*?>
                    <div style="text-align:center"><span style="border:1px solid orange;padding:5px;border-radis:10px">Education Check</span></div>
                    <?php*/
            ...
            elseif($sece_nme == 'national-id-check-1'){
                //report upload st
                //selection of docs in applications
                   $sel2anx26=mysqli_query($con,"select * from national_id_check_1 where appl_id='$apid'");
                ...
                foreach($_FILES["filenational_id_check_1"]["tmp_name"] as $key26=>$tmp_name26) {
                              ...
                              $imgRANDM26='naid1up'.$apid.$imgRANDMR26;
            ...
            /*$coverImgdir = $coverImgdir.'/'.$imagename;*/
              ...
              $postgr26=ltrim($postgr26,',').',';
                ...
                //report upload ed
                $naid=mysqli_query($con,"update national_id_check_1 set nttyid='$nttyid',ntidcrd='$ntidcrd',ntdovery='$ntdovery',ntvrresul='$ntvrresul',ntverby='$ntverby',nttyid2='$nttyid2',ntidcrd2='$ntidcrd2',ntdovery2='$ntdovery2',ntvrresul2='$ntvrresul2',ntverby2='$ntverby2',remarks='$rmknational_id_check_1',date='$dap',source='$srocnational_id_check_1',location='$lcntinnational_id_check_1',cmpl_date='$cmpdtenational_id_check_1',color_code='$clrcdenational_id_check_1',add_fe='$add_feenational_id_check_1',report='$postgr26' where appl_id='$apid'");
                if($naid){
                    /*?>
                    <div style="text-align:center"><span style="border:1px solid orange;padding:5px;border-radis:10px">Education Check</span></div>
                    <?php*/
                ...
                //report upload st
                //selection of docs in applications
                   $sel2anx262=mysqli_query($con,"select * from national_id_check_2 where appl_id='$apid'");
                   $selresanx2262=mysqli_fetch_assoc($sel2anx262);
                   $docs262=$selresanx2262['report'];
                 if($filcnttnational_id_check_2 > 0){
                   $docsexp262=explode(',',$docs262);
                   $docscnt262=count($docsexp262)-1;
                   $dc262=0;
                   for($dc262=0; $dc262 < $docscnt262; $dc262++){
                   $docone262=$docsexp262[$dc262];
                   unlink($docone262);
                   }
                foreach($_FILES["filenational_id_check_2"]["tmp_name"] as $key262=>$tmp_name262) {
                              ...
                              $imgRANDM262='naid2up'.$apid.$imgRANDMR262;
            ...
            /*$coverImgdir = $coverImgdir.'/'.$imagename;*/
              ...
              $postgr262=ltrim($postgr262,',').',';
                ...
                //report upload ed
                $naid2=mysqli_query($con,"update national_id_check_2 set nttyid2='$nttyid2',ntidcrd2='$ntidcrd2',ntdovery2='$ntdovery2',ntvrresul2='$ntvrresul2',ntverby2='$ntverby2',nttyid2_2='$nttyid2_2',ntidcrd2_2='$ntidcrd2_2',ntdovery2_2='$ntdovery2_2',ntvrresul2_2='$ntvrresul2_2',ntverby2_2='$ntverby2_2',remarks='$rmknational_id_check_2',date='$dap',source='$srocnational_id_check_2',location='$lcntinnational_id_check_2',cmpl_date='$cmpdtenational_id_check_2',color_code='$clrcdenational_id_check_2',add_fe='$add_feenational_id_check_2',report='$postgr26' where appl_id='$apid'");
                if($naid2){
                    /*?>
                    <div style="text-align:center"><span style="border:1px solid orange;padding:5px;border-radis:10px">Education Check</span></div>
                    <?php*/
...
function servicelistSelected($listItem)
{
