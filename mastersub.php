...
if($ovrlst == 'completed'){
      ...
      <div>Our customer service team will be available for any support  24 x 7.</div><br>
         <div><a href='http://www.goldquestglobal.in/pdf/rpt.php?reff_id=$apid'><button style='background-color:#337fbf;color:white;border:none'>Download Final Report</button></a></div><br>
...
if($qry){
    ...
    $insta_drug_panel=$_POST['stainsta_drug_panel'];// ADded for insta drug panel by Anees on Mar 12, 2021
    ...
    emp_hr_1='$staemp_hr_1',emp_hr_2='$staemp_hr_2',emp_hr_3='$staemp_hr_3',emp_hr_4='$staemp_hr_4',emp_hr_5='$staemp_hr_5',emp_hr_6='$staemp_hr_6',emp_hr_7='$staemp_hr_7',
    emp_hr_8='$staemp_hr_8',post_graduation='$stapost_graduation',graduation='$stagraduation',12th_std='$std_12',10th_std='$std_10',
    diploma='$stadiploma',pro_reference_1='$stapro_reference_1',pro_reference_2='$stapro_reference_2',insta_drug_panel='$insta_drug_panel',criminal_court_record='$stacriminal_court_record',
    criminal_database='$stacriminal_database',credit_verification='$stacredit_verification',criminal_police_record='$stacriminal_police_record',
...
/*            $appl_details=$bqryrs['appl_shrt'];
        ...
        header('location:http://www.goldquestglobal.in/masterchecker.php?ref_id='.$apid);
    }
}
else{
    echo 'oOPS!';
...
/*            $appl_details=$bqryrs['appl_shrt'];
            ...
            }elseif($sece_nme == 'insta_drug_test'){
                //report upload st
                //selection of docs in applications
