...
<html>
    ...
    <body>
        <header class="head">
            <a href="http://www.goldquestglobal.in">GoldQuest Verification Tracking System-VTS</a><span class="log">&nbsp;<a href="http://www.goldquestglobal.in"><?php echo $emp_name;?></a></span>
            </header>
            <section class="sec1">
            ...
            <div class="cms-sub">
                <div id="adcltri" class="bnpl" onclick="cmsac(this)"  data-adc="cmsad"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;New Client Registration</div>
                <div class="bnpl" onclick="cmscm(this)"  data-cmg="cmsmgs"><i class="fa fa-eye"></i>&nbsp;&nbsp;Active Client List</div>
                <div class="bnpl" onclick="blkusr(this)"  data-blkus="blkusrs"><i class="fa fa-eye-slash"></i>&nbsp;&nbsp;Inactive Client List</div>
            ...
            if($emp_role == 'admin'){
                ...
                <div id="emp" onclick="addemp(this)"  data-adempp="ademploye" class="list add-emp-sub"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Add employee</div>
            ...
            <!-- <div id="invc" onclick="invc(this)"  data-invo="invoice" class="list"><img src="images/business-and-finance.png">&nbsp;&nbsp;Accounts & Finance</div> ###-14/02/2021 -Anees-->

            <div id="invc" onclick="invc(this)"  data-invo="invoice" class="list"><img src="images/business-and-finance.png">&nbsp;&nbsp;Generate Invoice</div>
...
<?php
    ...
    header('location:'.APP_PATH.'/login');#CH
   // header('location:http://localhost/GoldQuest/login/index.php?er=err');
}
