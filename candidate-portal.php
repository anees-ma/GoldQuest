        ...
        <?php 
          if(isset($_GET['application'])){
            if($_GET['application']==true){
              $alertClass= 'success';
              $notificationText = '<strong>Success!</strong> Application Done Successfully.';
            }else{
              $alertClass= 'danger';
              $notificationText = '<strong>Failed!</strong> Please Try Again.';
            }
        ?>

        <div class="alert alert-<?php echo $alertClass; ?> alert-dismissible">
