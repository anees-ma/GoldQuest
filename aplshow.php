...
<div class="task_tabl" style="clear:both;overflow-x: scroll;">
    <table class="dataTable-rpt tbl_data tbl_data2" style="">
        <thead>
        ...
        <tr>
            ...
            <?php 
                ...
                <td>
                   ...
                   <td><a class="deleteReportSingle" data-id="<?php echo $qryres['id'];?>" data-clientuid="<?php echo $seservres['client_uid']?>" data-status="<?php echo $over_all_status_?>"><button class="btn btn-danger">Delete</button></a></td>
                </tr>
                <?php
                $sl_no++;
...
<script>
  ...
  //function deleteReportSingle(data){
    $(document).on('click','.deleteReportSingle', function(){
      if(confirm("Are you sure, you want to delete?")){
        let applicId = $(this).attr('data-id');
        ...
        $.ajax({
          ...
          type: 'post',
          data: {applicId:applicId,delete_report_single:'true',status: status, clientUid: clientUid},
          beforeSend: function(){
                //$('.right .right_con').html('<img src="images/ezgif-2-6d0b072c3d3f.gif" style="width:350px">');
          },
          success: function(resp){
